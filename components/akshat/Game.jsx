...
const initialStocks = [
  {
    ...
    sector: "Technology",
    description:
      "A leading technology company specializing in cloud computing and AI. Pros: Strong market position, innovative products. Cons: High competition, regulatory risks.",
    phase1Impact: {
      price: 120,
      description:
        "TechCorp benefited from increased demand for cloud services during the pandemic.",
    },
    phase2Impact: {
      price: 80,
      description:
        "TechCorp faced supply chain disruptions and chip shortages.",
    },
    phase3Impact: {
      price: 150,
      description:
        "TechCorp successfully launched a new AI platform, boosting investor confidence.",
    },
  },
  {
    id: 2,
    ...
    sector: "Healthcare",
    description:
      "A healthcare provider focusing on telemedicine and digital health. Pros: Growing market, essential service. Cons: High operational costs, regulatory compliance.",
    phase1Impact: {
      price: 200,
      description:
        "HealthCare Plus saw massive growth in telemedicine services.",
    },
    phase2Impact: {
      price: 130,
      description:
        "Healthcare Plus faced staffing shortages and increased costs.",
    },
    phase3Impact: {
      price: 180,
      description:
        "Healthcare Plus expanded into new markets, improving profitability.",
    },
  },
  {
    id: 3,
    ...
    sector: "Energy",
    description:
      "An energy company transitioning to renewable sources. Pros: Green energy focus, government support. Cons: High capital expenditure, market volatility.",
    phase1Impact: {
      price: 60,
      description:
        "EnergyCo suffered from reduced energy demand during lockdowns.",
    },
    phase2Impact: {
      price: 100,
      description:
        "EnergyCo benefited from rising oil prices and increased renewable investments.",
    },
    phase3Impact: {
      price: 70,
      description:
        "EnergyCo faced challenges with new environmental regulations.",
    },
  },
  {
    id: 4,
    ...
    sector: "Finance",
    description:
      "A traditional bank expanding into digital banking. Pros: Stable business model, strong balance sheet. Cons: Interest rate sensitivity, regulatory changes.",
    phase1Impact: {
      price: 90,
      description:
        "FinanceBank faced increased loan defaults and reduced interest rates.",
    },
    phase2Impact: {
      price: 140,
      description:
        "FinanceBank benefited from rising interest rates and improved loan quality.",
    },
    phase3Impact: {
      price: 110,
      description:
        "FinanceBank faced increased competition from fintech companies.",
    },
  },
  {
    id: 5,
    ...
    sector: "Retail",
    description:
      "A retail chain with strong e-commerce presence. Pros: Omnichannel strategy, brand recognition. Cons: Thin margins, competition from online retailers.",
    phase1Impact: {
      price: 70,
      description:
        "RetailPro struggled with store closures and supply chain issues.",
    },
    phase2Impact: {
      price: 110,
      description:
        "RetailPro benefited from strong online sales and reopening of stores.",
    },
    phase3Impact: {
      price: 85,
      description:
        "RetailPro faced increased competition and rising operational costs.",
    },
  },
];
...
const Game = () => {
  ...
  const botTrade = () => {
    ...
    const quantity = Math.max(
      1,
      Math.min(Math.floor(Math.random() * 3) + 1, maxQuantity)
    );
    ...
    if (action === "buy" && botPortfolio.cash >= randomStock.price * quantity) {
      ...
      action === "sell" &&
      botPortfolio.holdings[randomStock.id] >= quantity
    ) {
      setBotPortfolio((prev) => ({
        ...prev,
        ...
        holdings: {
          ...prev.holdings,
          [randomStock.id]: Math.max(
            0,
            prev.holdings[randomStock.id] - quantity
          ),
        },
      }));
    }
  ...
  const handlePlayerTrade = (stockId, action, quantity) => {
    ...
    if (
      action === "buy" &&
      playerPortfolio.cash >= stock.price * safeQuantity
    ) {
      ...
      action === "sell" &&
      playerPortfolio.holdings[stockId] >= safeQuantity
    ) {
      setPlayerPortfolio((prev) => ({
        ...prev,

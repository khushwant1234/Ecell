      ...
      <div className="w-full h-screen flex flex-col bg-gray-50">
        <header className="w-full p-4 sm:p-6 bg-white border-b border-gray-200 shadow-sm">
          <div className="max-w-5xl mx-auto flex justify-between items-center">
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-gray-800">Early Recruitment Registration</h2>
              <p className="text-gray-500 text-sm">Get notified about exciting opportunities first!</p>
            </div>
            <button onClick={handleExitForm} className="text-gray-500 hover:text-gray-800 transition">
    ...
    return (
      <div className="w-full max-w-2xl bg-white p-8 sm:p-12 rounded-2xl shadow-xl text-center">
        ...
        <p className="mt-4 text-lg text-gray-600">
          Thank you for your interest in early recruitment. We&apos;ve received your registration and will contact you at <strong>{formData.email}</strong> with updates about exciting opportunities before they go public.
        </p>
        <button
                ...
                <div className="text-center">
                  <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-blue-600 to-purple-600 rounded-full flex items-center justify-center">
                    <svg className="w-10 h-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0H8m8 0v2a2 2 0 002 2M8 6v2a2 2 0 01-2 2M8 6V4m0 2H4m0 0v2a2 2 0 002 2h4m4-6V4" />
                    </svg>
                  </div>
                  <h1 className="text-4xl md:text-6xl font-extrabold text-white mb-4">Early Recruitment</h1>
                  <p className="text-lg md:text-xl text-gray-300 mb-8">
                    Get notified about exciting opportunities before they go public!
                  </p>
                  <button
